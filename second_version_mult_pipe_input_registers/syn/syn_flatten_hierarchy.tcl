...
analyze -f vhdl -lib WORK ../src/fpnormalize_fpnormlize.vhd
...
# report
report_power > ../netlist/results/FP_mul_flatten_power.txt
report_power -net > ../netlist/results/FP_mul_flatten_power_net.txt
report_power -hier > ../netlist/results/FP_mul_flatten_power_hier.txt
report_timing > ../netlist/results/FP_mul_flatten_timing.txt
report_area -hierarchy > ../netlist/results/FP_mul_flatten_area.txt
