...
report_power -net > ../netlist/results/FP_mul_fine_grain_pipe_compile_ultra_clock/power_net.txt
report_power -hier > ../netlist/results/FP_mul_fine_grain_pipe_compile_ultra_clock/power_hier.txt
report_timing > ../netlist/results/FP_mul_fine_grain_pipe_compile_ultra_clock/timing.txt
report_area -hierarchy > ../netlist/results/FP_mul_fine_grain_pipe_compile_ultra_clock/area.txt
report_resources > ../netlist/results/FP_mul_fine_grain_pipe_compile_ultra_clock/resources.txt
