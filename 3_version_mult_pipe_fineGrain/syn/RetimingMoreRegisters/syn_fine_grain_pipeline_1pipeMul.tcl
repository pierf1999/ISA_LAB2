...
# ddc file saving
write -hierarchy -format ddc -output ../netlist/ddc_files/FP_mul_fine_grain_1pipe.ddc

# report
report_power > ../netlist/results/FP_mul_fine_grain_1pipe/power.txt
report_power -net > ../netlist/results/FP_mul_fine_grain_1pipe/power_net.txt
report_power -hier > ../netlist/results/FP_mul_fine_grain_1pipe/power_hier.txt
report_timing > ../netlist/results/FP_mul_fine_grain_1pipe/timing.txt
report_area -hierarchy > ../netlist/results/FP_mul_fine_grain_1pipe/area.txt
